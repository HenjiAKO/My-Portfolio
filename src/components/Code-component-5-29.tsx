...
export function Skills() {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        { name: ".NET Framework", level: 80, color: "bg-indigo-500" },
        { name: "MonoGame", level: 75, color: "bg-green-500" },
        { name: "React", level: 70, color: "bg-cyan-500" },
        { name: "ASP.NET", level: 65, color: "bg-blue-600" },
      ]
    },
    {
      ...
      skills: [
        { name: "Game Design", level: 75, color: "bg-pink-500" },
        { name: "Aseprite", level: 80, color: "bg-red-500" },
        { name: "2D Graphics", level: 70, color: "bg-purple-600" },
        { name: "Game Logic", level: 85, color: "bg-indigo-600" },
      ]
    },
    {
      ...
      skills: [
        { name: "Frontend Development", level: 85, color: "bg-green-500" },
        { name: "Backend Development", level: 75, color: "bg-teal-500" },
        { name: "Database Design", level: 70, color: "bg-blue-500" },
        { name: "API Development", level: 65, color: "bg-purple-500" },
      ]
    },
  ];

  const tools = [
    "Visual Studio", "Git", "GitHub", "Aseprite", "Photoshop", 
    "Figma", "VS Code", "SQL Server", "Unity (Learning)"
  ];
